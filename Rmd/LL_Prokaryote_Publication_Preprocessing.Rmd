...
```{r}
# Metadata #
samp_dat_bac <- read.csv("C:/Users/emrog/Documents/RProjects/Spermosphere_Across_Different_Soils/Spermosphere_16S_Metadata.csv", na.strings = "na")
...
otu_bac <- read.csv("C:/Users/emrog/Documents/RProjects/Spermosphere_Across_Different_Soils/otu_table_16S_Bacteria.txt", sep = "\t") #txt file is tab separated
...
# Taxonomy #
taxonomy.bac <- read.csv("C:/Users/emrog/Documents/RProjects/Spermosphere_Across_Different_Soils/16s_taxonomy_SINTAX.txt", sep = "")
...
#FASTA.bac <- readDNAStringSet("C:/Users/emrog/Documents/RProjects/Spermosphere_Across_Different_Soils/otus.fasta", format="fasta", seek.first.rec=TRUE, use.names=TRUE)

# Phylogentic tree #
tree <- phyloseq::read_tree("C:/Users/emrog/Documents/RProjects/Spermosphere_Across_Different_Soils/otu_tree.tre")

###### Create Initial Phyloseq object #####
# Merge reads into Phyloseq object #
bac.unedited <- phyloseq::phyloseq(OTU.bac, TAX.bac, SAMP.bac, tree)
```
