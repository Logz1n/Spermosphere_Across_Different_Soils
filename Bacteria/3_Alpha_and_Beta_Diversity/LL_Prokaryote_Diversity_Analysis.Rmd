...
author: "Logan Luchs and Emily Roggenkamp"
date: "2025-04-23"
output: 
  md_document:
    toc: true
...
```
## North Dakota Soil ##
```{r North Dakota Alpha Diversity}
### Calculating Shannon, Simpson, Inverse Simpson and Pielou's Eveness ###
...
```
## Pennsylvania Soil ##
```{r Pennsylvania Alpha Diversity}
### Calculating Shannon, Simpson, Inverse Simpson and Pielou's Eveness ###
...
###Merging Locations Alpha Diversity Data Frames###
...
```{r Plotting Richness,warning=FALSE}
...
```{r Plotting Faiths Phylogenetic Diversity, warning=FALSE}
...
```{r Plotting Pielous Eveness,warning=FALSE}
...
BAlphaCombined$Time <- factor(BAlphaCombined$Time, levels = c("0", "8", "12","16"))
...
# Since the data may not normally distributed because and it is count data. Fit a Poisson regression model to predict 'richness' based on 'Type.revised', 'Time', 'Trt', and their interactions
...
```{r Faiths Phylogenetic Diversity Statstics,warning=FALSE}
