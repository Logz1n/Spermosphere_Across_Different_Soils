...
#ggsave(filename = "even_usearch25.png", plot = fungi.even, device = "png", width = 178, height = 178, units="mm", dpi = 600)
```
...
#ggsave(filename = "beta_usearch25.png", plot = beta, device = "png", width = 250, height = 150, units="mm", dpi = 600)
```
...
pcoa.bray.12hrs.new <- ggplot(bray.12.vectors2, aes(x = Axis.1, y = Axis.2, fill = Location_EC, shape = Sample_Type)) +
  ...
  guides(fill = guide_legend(override.aes = list(shape = 21))) +
  ggtitle(paste("12 hrs post planting")) +
  theme_bw() +
  theme(legend.position = "bottom",
        legend.title = element_blank(),
        legend.key = element_blank(),
...
pcoa.bray.16hrs.new <- ggplot(bray.16.vectors2, aes(x = Axis.1, y = Axis.2, fill = Location_EC, shape = Sample_Type)) +
  ...
  guides(fill = guide_legend(override.aes = list(shape = 21))) +
  ggtitle(paste("16 hrs post planting")) +
  theme_bw() +
  theme(legend.position = "bottom",
        legend.title = element_blank(),
        legend.key = element_blank(),
